...
<?php
	...
	if (isset($_POST['wyslij'])){
		...
		if ($valid = true){
			...
			pg_query("INSERT INTO kucharz(imie, nazwisko, placa, telefon) VALUES('$imie', '$nazwisko', '$placa', '$telefon')");
...
?> 
	...
	<div class="container">
	<br><br><br>
		<h1 class="display-4">Dodaj nowego kucharza</h1>

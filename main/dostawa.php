...
<html lang="pl">
<head>
  <title>Dostarczanie zamówienia</title>
...
<body>
	<div class="container">
	<br><br><br>
		<h1 class="display-4">Dostarczanie zamówienia</h1>
		<?php
			...
			if (isset($_POST['wyslij'])){
				pg_query("UPDATE zamowienie SET id_kur = $id, stan = 3, data_real = now() WHERE id_zam = $zam");
				header("Location: kurier_praca.php");
				exit();				
			}
		...
		?>
			...
			<div class="col-sm-4">
				...
				<div class="col-sm-7">
					<input type="submit" id="wyslij" name="wyslij" class="btn btn-primary" value="Dostarczono zamówienie">
				</div>
			</div>	
		</form>
	</div>

...
<?php
	...
	if($stat === PGSQL_CONNECTION_OK){
		...
		$result = pg_query("SELECT z.id_kl, z.adres, z.cena, z.data_zam, z.data_przyg, z.data_kur, z.data_real, kur.imie ||' '|| kur.nazwisko AS kurier, kuch.imie ||' '|| kuch.nazwisko AS kucharz FROM zamowienie z INNER JOIN kurier kur ON z.id_kur = kur.id_kur INNER JOIN kucharz kuch ON z.id_kuch = kuch.id_kuch WHERE z.id_zam = $idZ");
...
<center><a href="../list/klient_zam.php?id=<?php echo $id; ?>" class="btn btn-warning">Wróć</a></center>
